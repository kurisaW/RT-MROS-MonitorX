  ...
  test_msgs__srv__Arrays_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    test_msgs__srv__Arrays_Request * data =
      (test_msgs__srv__Arrays_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!test_msgs__srv__Arrays_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          test_msgs__srv__Arrays_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  test_msgs__srv__Arrays_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    test_msgs__srv__Arrays_Response * data =
      (test_msgs__srv__Arrays_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!test_msgs__srv__Arrays_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          test_msgs__srv__Arrays_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
