...
#ifndef TEST_MSGS__SRV__EMPTY__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, srv, Empty_Request)();
...
ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_PUBLIC_test_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, srv, Empty_Response)();
...
const rosidl_service_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, srv, Empty)();

#ifdef __cplusplus
}
#endif

#endif  // TEST_MSGS__SRV__EMPTY__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
