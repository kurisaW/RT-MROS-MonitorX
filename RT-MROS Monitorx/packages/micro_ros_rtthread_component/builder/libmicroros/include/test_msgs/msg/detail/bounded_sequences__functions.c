...
test_msgs__msg__BoundedSequences__create()
{
  ...
  test_msgs__msg__BoundedSequences * msg = (test_msgs__msg__BoundedSequences *)allocator.allocate(sizeof(test_msgs__msg__BoundedSequences), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(test_msgs__msg__BoundedSequences));
  bool success = test_msgs__msg__BoundedSequences__init(msg);
  if (!success) {
...
test_msgs__msg__BoundedSequences__Sequence__init(test_msgs__msg__BoundedSequences__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_msgs__msg__BoundedSequences * data = NULL;

  if (size) {
    data = (test_msgs__msg__BoundedSequences *)allocator.zero_allocate(size, sizeof(test_msgs__msg__BoundedSequences), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = test_msgs__msg__BoundedSequences__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        test_msgs__msg__BoundedSequences__fini(&data[i - 1]);
      }
...
test_msgs__msg__BoundedSequences__Sequence__fini(test_msgs__msg__BoundedSequences__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      test_msgs__msg__BoundedSequences__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_msgs__msg__BoundedSequences__Sequence * array = (test_msgs__msg__BoundedSequences__Sequence *)allocator.allocate(sizeof(test_msgs__msg__BoundedSequences__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = test_msgs__msg__BoundedSequences__Sequence__init(array, size);
  if (!success) {
...
test_msgs__msg__BoundedSequences__Sequence__destroy(test_msgs__msg__BoundedSequences__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    test_msgs__msg__BoundedSequences__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
test_msgs__msg__BoundedSequences__Sequence__are_equal(const test_msgs__msg__BoundedSequences__Sequence * lhs, const test_msgs__msg__BoundedSequences__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!test_msgs__msg__BoundedSequences__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  test_msgs__msg__BoundedSequences__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(test_msgs__msg__BoundedSequences);
    test_msgs__msg__BoundedSequences * data =
      (test_msgs__msg__BoundedSequences *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!test_msgs__msg__BoundedSequences__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          test_msgs__msg__BoundedSequences__fini(&data[i]);
        }
        free(data);
        return false;
      }
