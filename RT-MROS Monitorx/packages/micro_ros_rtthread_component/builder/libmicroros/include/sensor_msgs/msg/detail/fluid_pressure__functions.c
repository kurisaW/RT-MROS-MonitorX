...
sensor_msgs__msg__FluidPressure__Sequence__init(sensor_msgs__msg__FluidPressure__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (sensor_msgs__msg__FluidPressure *)allocator.zero_allocate(size, sizeof(sensor_msgs__msg__FluidPressure), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensor_msgs__msg__FluidPressure__Sequence * array = (sensor_msgs__msg__FluidPressure__Sequence *)allocator.allocate(sizeof(sensor_msgs__msg__FluidPressure__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
