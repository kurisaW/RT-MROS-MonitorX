  ...
  sensor_msgs__srv__SetCameraInfo_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    sensor_msgs__srv__SetCameraInfo_Request * data =
      (sensor_msgs__srv__SetCameraInfo_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sensor_msgs__srv__SetCameraInfo_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          sensor_msgs__srv__SetCameraInfo_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  sensor_msgs__srv__SetCameraInfo_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    sensor_msgs__srv__SetCameraInfo_Response * data =
      (sensor_msgs__srv__SetCameraInfo_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sensor_msgs__srv__SetCameraInfo_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          sensor_msgs__srv__SetCameraInfo_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
