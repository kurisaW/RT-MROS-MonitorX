...
bool
std_msgs__msg__Int32__are_equal(const std_msgs__msg__Int32 * lhs, const std_msgs__msg__Int32 * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
std_msgs__msg__Int32__copy(
  const std_msgs__msg__Int32 * input,
  std_msgs__msg__Int32 * output)
{
  if (!input || !output) {
    return false;
  }
...
std_msgs__msg__Int32__create()
{
  ...
  std_msgs__msg__Int32 * msg = (std_msgs__msg__Int32 *)allocator.allocate(sizeof(std_msgs__msg__Int32), allocator.state);
  if (!msg) {
    return NULL;
  }
...
std_msgs__msg__Int32__Sequence__init(std_msgs__msg__Int32__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (std_msgs__msg__Int32 *)allocator.zero_allocate(size, sizeof(std_msgs__msg__Int32), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  std_msgs__msg__Int32__Sequence * array = (std_msgs__msg__Int32__Sequence *)allocator.allocate(sizeof(std_msgs__msg__Int32__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
std_msgs__msg__Int32__Sequence__are_equal(const std_msgs__msg__Int32__Sequence * lhs, const std_msgs__msg__Int32__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!std_msgs__msg__Int32__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
std_msgs__msg__Int32__Sequence__copy(
  const std_msgs__msg__Int32__Sequence * input,
  std_msgs__msg__Int32__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(std_msgs__msg__Int32);
    std_msgs__msg__Int32 * data =
      (std_msgs__msg__Int32 *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!std_msgs__msg__Int32__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          std_msgs__msg__Int32__fini(&data[i]);
        }
        free(data);
        return false;
      }
