...
bool
std_msgs__msg__String__are_equal(const std_msgs__msg__String * lhs, const std_msgs__msg__String * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
std_msgs__msg__String__create()
{
  ...
  std_msgs__msg__String * msg = (std_msgs__msg__String *)allocator.allocate(sizeof(std_msgs__msg__String), allocator.state);
  if (!msg) {
    return NULL;
  }
...
std_msgs__msg__String__Sequence__init(std_msgs__msg__String__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (std_msgs__msg__String *)allocator.zero_allocate(size, sizeof(std_msgs__msg__String), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  std_msgs__msg__String__Sequence * array = (std_msgs__msg__String__Sequence *)allocator.allocate(sizeof(std_msgs__msg__String__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
std_msgs__msg__String__Sequence__are_equal(const std_msgs__msg__String__Sequence * lhs, const std_msgs__msg__String__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!std_msgs__msg__String__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
std_msgs__msg__String__Sequence__copy(
  const std_msgs__msg__String__Sequence * input,
  std_msgs__msg__String__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(std_msgs__msg__String);
    std_msgs__msg__String * data =
      (std_msgs__msg__String *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!std_msgs__msg__String__init(&data[i])) {
        ...
        for (; i-- > output->capacity; ) {
          std_msgs__msg__String__fini(&data[i]);
        }
        free(data);
        return false;
      }
