...
std_msgs__msg__UInt32__create()
{
  ...
  memset(msg, 0, sizeof(std_msgs__msg__UInt32));
  bool success = std_msgs__msg__UInt32__init(msg);
  if (!success) {
...
std_msgs__msg__UInt32__destroy(std_msgs__msg__UInt32 * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    std_msgs__msg__UInt32__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
std_msgs__msg__UInt32__Sequence__init(std_msgs__msg__UInt32__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  std_msgs__msg__UInt32 * data = NULL;

  if (size) {
    data = (std_msgs__msg__UInt32 *)allocator.zero_allocate(size, sizeof(std_msgs__msg__UInt32), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = std_msgs__msg__UInt32__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        std_msgs__msg__UInt32__fini(&data[i - 1]);
      }
...
std_msgs__msg__UInt32__Sequence__fini(std_msgs__msg__UInt32__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      std_msgs__msg__UInt32__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  std_msgs__msg__UInt32__Sequence * array = (std_msgs__msg__UInt32__Sequence *)allocator.allocate(sizeof(std_msgs__msg__UInt32__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = std_msgs__msg__UInt32__Sequence__init(array, size);
  if (!success) {
...
std_msgs__msg__UInt32__Sequence__destroy(std_msgs__msg__UInt32__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    std_msgs__msg__UInt32__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
std_msgs__msg__UInt32__Sequence__are_equal(const std_msgs__msg__UInt32__Sequence * lhs, const std_msgs__msg__UInt32__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!std_msgs__msg__UInt32__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  std_msgs__msg__UInt32__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(std_msgs__msg__UInt32);
    std_msgs__msg__UInt32 * data =
      (std_msgs__msg__UInt32 *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!std_msgs__msg__UInt32__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          std_msgs__msg__UInt32__fini(&data[i]);
        }
        free(data);
        return false;
      }
