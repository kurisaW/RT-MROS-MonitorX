...
std_msgs__msg__Float32__create()
{
  ...
  std_msgs__msg__Float32 * msg = (std_msgs__msg__Float32 *)allocator.allocate(sizeof(std_msgs__msg__Float32), allocator.state);
  if (!msg) {
    return NULL;
  }
...
std_msgs__msg__Float32__Sequence__init(std_msgs__msg__Float32__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (std_msgs__msg__Float32 *)allocator.zero_allocate(size, sizeof(std_msgs__msg__Float32), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  std_msgs__msg__Float32__Sequence * array = (std_msgs__msg__Float32__Sequence *)allocator.allocate(sizeof(std_msgs__msg__Float32__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
