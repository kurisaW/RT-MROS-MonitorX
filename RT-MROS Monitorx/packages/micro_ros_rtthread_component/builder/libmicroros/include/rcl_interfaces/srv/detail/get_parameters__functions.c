...
bool
rcl_interfaces__srv__GetParameters_Request__are_equal(const rcl_interfaces__srv__GetParameters_Request * lhs, const rcl_interfaces__srv__GetParameters_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rcl_interfaces__srv__GetParameters_Request__copy(
  const rcl_interfaces__srv__GetParameters_Request * input,
  rcl_interfaces__srv__GetParameters_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
rcl_interfaces__srv__GetParameters_Request__create()
{
  ...
  rcl_interfaces__srv__GetParameters_Request * msg = (rcl_interfaces__srv__GetParameters_Request *)allocator.allocate(sizeof(rcl_interfaces__srv__GetParameters_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rcl_interfaces__srv__GetParameters_Request__Sequence__init(rcl_interfaces__srv__GetParameters_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rcl_interfaces__srv__GetParameters_Request *)allocator.zero_allocate(size, sizeof(rcl_interfaces__srv__GetParameters_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetParameters_Request__Sequence * array = (rcl_interfaces__srv__GetParameters_Request__Sequence *)allocator.allocate(sizeof(rcl_interfaces__srv__GetParameters_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rcl_interfaces__srv__GetParameters_Request__Sequence__are_equal(const rcl_interfaces__srv__GetParameters_Request__Sequence * lhs, const rcl_interfaces__srv__GetParameters_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rcl_interfaces__srv__GetParameters_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
rcl_interfaces__srv__GetParameters_Request__Sequence__copy(
  const rcl_interfaces__srv__GetParameters_Request__Sequence * input,
  rcl_interfaces__srv__GetParameters_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rcl_interfaces__srv__GetParameters_Request);
    rcl_interfaces__srv__GetParameters_Request * data =
      (rcl_interfaces__srv__GetParameters_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rcl_interfaces__srv__GetParameters_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rcl_interfaces__srv__GetParameters_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rcl_interfaces__srv__GetParameters_Request__copy(
...
bool
rcl_interfaces__srv__GetParameters_Response__are_equal(const rcl_interfaces__srv__GetParameters_Response * lhs, const rcl_interfaces__srv__GetParameters_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rcl_interfaces__srv__GetParameters_Response__copy(
  const rcl_interfaces__srv__GetParameters_Response * input,
  rcl_interfaces__srv__GetParameters_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetParameters_Response * msg = (rcl_interfaces__srv__GetParameters_Response *)allocator.allocate(sizeof(rcl_interfaces__srv__GetParameters_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rcl_interfaces__srv__GetParameters_Response__Sequence__init(rcl_interfaces__srv__GetParameters_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rcl_interfaces__srv__GetParameters_Response *)allocator.zero_allocate(size, sizeof(rcl_interfaces__srv__GetParameters_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rcl_interfaces__srv__GetParameters_Response__Sequence * array = (rcl_interfaces__srv__GetParameters_Response__Sequence *)allocator.allocate(sizeof(rcl_interfaces__srv__GetParameters_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rcl_interfaces__srv__GetParameters_Response__Sequence__are_equal(const rcl_interfaces__srv__GetParameters_Response__Sequence * lhs, const rcl_interfaces__srv__GetParameters_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rcl_interfaces__srv__GetParameters_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
rcl_interfaces__srv__GetParameters_Response__Sequence__copy(
  ...
  rcl_interfaces__srv__GetParameters_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rcl_interfaces__srv__GetParameters_Response);
    rcl_interfaces__srv__GetParameters_Response * data =
      (rcl_interfaces__srv__GetParameters_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rcl_interfaces__srv__GetParameters_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rcl_interfaces__srv__GetParameters_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rcl_interfaces__srv__GetParameters_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
