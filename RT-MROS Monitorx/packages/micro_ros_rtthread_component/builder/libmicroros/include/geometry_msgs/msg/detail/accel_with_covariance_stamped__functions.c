...
geometry_msgs__msg__AccelWithCovarianceStamped__create()
{
  ...
  geometry_msgs__msg__AccelWithCovarianceStamped * msg = (geometry_msgs__msg__AccelWithCovarianceStamped *)allocator.allocate(sizeof(geometry_msgs__msg__AccelWithCovarianceStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
...
geometry_msgs__msg__AccelWithCovarianceStamped__Sequence__init(geometry_msgs__msg__AccelWithCovarianceStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geometry_msgs__msg__AccelWithCovarianceStamped *)allocator.zero_allocate(size, sizeof(geometry_msgs__msg__AccelWithCovarianceStamped), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  geometry_msgs__msg__AccelWithCovarianceStamped__Sequence * array = (geometry_msgs__msg__AccelWithCovarianceStamped__Sequence *)allocator.allocate(sizeof(geometry_msgs__msg__AccelWithCovarianceStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
geometry_msgs__msg__AccelWithCovarianceStamped__Sequence__are_equal(const geometry_msgs__msg__AccelWithCovarianceStamped__Sequence * lhs, const geometry_msgs__msg__AccelWithCovarianceStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!geometry_msgs__msg__AccelWithCovarianceStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  geometry_msgs__msg__AccelWithCovarianceStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(geometry_msgs__msg__AccelWithCovarianceStamped);
    geometry_msgs__msg__AccelWithCovarianceStamped * data =
      (geometry_msgs__msg__AccelWithCovarianceStamped *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!geometry_msgs__msg__AccelWithCovarianceStamped__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          geometry_msgs__msg__AccelWithCovarianceStamped__fini(&data[i]);
        }
        free(data);
        return false;
      }
