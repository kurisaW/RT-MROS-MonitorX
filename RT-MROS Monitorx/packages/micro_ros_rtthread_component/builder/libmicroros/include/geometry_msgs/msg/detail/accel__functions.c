...
bool
geometry_msgs__msg__Accel__are_equal(const geometry_msgs__msg__Accel * lhs, const geometry_msgs__msg__Accel * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
geometry_msgs__msg__Accel__copy(
  const geometry_msgs__msg__Accel * input,
  geometry_msgs__msg__Accel * output)
{
  if (!input || !output) {
    return false;
  }
...
geometry_msgs__msg__Accel__Sequence__init(geometry_msgs__msg__Accel__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geometry_msgs__msg__Accel *)allocator.zero_allocate(size, sizeof(geometry_msgs__msg__Accel), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  geometry_msgs__msg__Accel__Sequence * array = (geometry_msgs__msg__Accel__Sequence *)allocator.allocate(sizeof(geometry_msgs__msg__Accel__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
geometry_msgs__msg__Accel__Sequence__are_equal(const geometry_msgs__msg__Accel__Sequence * lhs, const geometry_msgs__msg__Accel__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!geometry_msgs__msg__Accel__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
geometry_msgs__msg__Accel__Sequence__copy(
  const geometry_msgs__msg__Accel__Sequence * input,
  geometry_msgs__msg__Accel__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(geometry_msgs__msg__Accel);
    geometry_msgs__msg__Accel * data =
      (geometry_msgs__msg__Accel *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!geometry_msgs__msg__Accel__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          geometry_msgs__msg__Accel__fini(&data[i]);
        }
        free(data);
        return false;
      }
