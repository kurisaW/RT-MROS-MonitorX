...
geometry_msgs__msg__TwistWithCovariance__create()
{
  ...
  geometry_msgs__msg__TwistWithCovariance * msg = (geometry_msgs__msg__TwistWithCovariance *)allocator.allocate(sizeof(geometry_msgs__msg__TwistWithCovariance), allocator.state);
  if (!msg) {
    return NULL;
  }
...
geometry_msgs__msg__TwistWithCovariance__Sequence__init(geometry_msgs__msg__TwistWithCovariance__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geometry_msgs__msg__TwistWithCovariance *)allocator.zero_allocate(size, sizeof(geometry_msgs__msg__TwistWithCovariance), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  geometry_msgs__msg__TwistWithCovariance__Sequence * array = (geometry_msgs__msg__TwistWithCovariance__Sequence *)allocator.allocate(sizeof(geometry_msgs__msg__TwistWithCovariance__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
