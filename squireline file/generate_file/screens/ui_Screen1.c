...
lv_obj_set_style_bg_color(ui_Screen1, lv_color_hex(0x5F5F62), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_imgbtn_set_src(ui_ImgButton1, LV_IMGBTN_STATE_RELEASED, NULL, &ui_img_startup_png, NULL);
lv_obj_set_height( ui_ImgButton1, 48);
lv_obj_set_width( ui_ImgButton1, LV_SIZE_CONTENT);  /// 1
lv_obj_set_x( ui_ImgButton1, -3 );
lv_obj_set_y( ui_ImgButton1, 91 );
lv_obj_set_align( ui_ImgButton1, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_ImgButton1, LV_OBJ_FLAG_EVENT_BUBBLE );   /// Flags
